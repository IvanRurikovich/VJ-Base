...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		-- General Menu (Used everywhere)
		add("vjbase.menu.general.default", "Padrão")
		add("vjbase.menu.general.admin.only", "Aviso: Somente administradores podem usar este menu.")
		add("vjbase.menu.general.admin.not", "Você não é um administrador!")
		add("vjbase.menu.general.reset.everything", "Resetar para o padrão")
		add("vjbase.menu.general.snpc.warnfuture", "AVISO: Somente SNPCS futuramente criados serão afetados!")
		add("vjbase.menu.general.snpc.creaturesettings", "Opções de criaturas:")
		add("vjbase.menu.general.snpc.humansettings", "Opções de Humanos:")
		
		-- Menu Tabs
		add("vjbase.menu.tabs.mainmenu", "Menu Principal")
		add("vjbase.menu.tabs.settings.snpc", "Opções de SNPCs")
		add("vjbase.menu.tabs.settings.weapon", "Opções de Armas")
		add("vjbase.menu.tabs.settings.hud", "Opções de HUD")
		add("vjbase.menu.tabs.tools", "Ferramentas")
		add("vjbase.menu.tabs.configures.snpc", "Configurações de SNPCs")
		
		-- Main Menu
		add("vjbase.menu.cleanup", "Limpar")
		add("vjbase.menu.cleanup.everything", "Limpar Tudo")
		add("vjbase.menu.cleanup.stopsounds", "Parar todos os sons")
		add("vjbase.menu.cleanup.remove.vjnpcs", "Remover todos os SNPCs VJ")
		add("vjbase.menu.cleanup.remove.npcs", "Remover todos os (S)NPCs")
		add("vjbase.menu.cleanup.remove.spawners", "Remover todos os Criadores")
		add("vjbase.menu.cleanup.remove.corpses", "Remover todos os Corpos")
		add("vjbase.menu.cleanup.remove.vjgibs", "Remover todos os membros decepados VJ")
		add("vjbase.menu.cleanup.remove.groundweapons", "Remover todas as armas no chão")
		add("vjbase.menu.cleanup.remove.props", "Remover todos os Props")
		add("vjbase.menu.cleanup.remove.decals", "Remover todos os Decalques")
		add("vjbase.menu.cleanup.remove.allweapons", "Remover todas as suas Armas")
		add("vjbase.menu.cleanup.remove.allammo", "Remover toda sua Munição")
		
		add("vjbase.menu.helpsupport", "Contato e Suporte")
		add("vjbase.menu.helpsupport.reportbug", "Reportar um Bug")
		add("vjbase.menu.helpsupport.suggestion", "Faça uma sugestão")
		add("vjbase.menu.helpsupport.discord", "Junte-se a mim no Discord!")
		add("vjbase.menu.helpsupport.steam", "Junte-se a mim na Steam!")
		add("vjbase.menu.helpsupport.youtube", "Se inscreva no Canal!")
		add("vjbase.menu.helpsupport.twtiter", "Me siga no Twitter!")
		add("vjbase.menu.helpsupport.patron", "Faça uma doação no Patreon")
		add("vjbase.menu.helpsupport.label1", "Siga um destes links para receber notícias sobre meus Addons!")
		add("vjbase.menu.helpsupport.label2", "Doações ajudam e me encorajam a continuar a criar e atualizar Addons! Obrigado!")
		add("vjbase.menu.helpsupport.thanks", "Obrigado por seu apoio!")
		
		add("vjbase.menu.svsettings", "Opções de Administrador do Servidor")
		add("vjbase.menu.svsettings.label", "AVISO: ALGUMAS OPÇÕES REQUEREM CHEATS ATIVADOS!")
		add("vjbase.menu.svsettings.admin.npcproperties", "Restringir propriedades dos SNPCs apenas a Administradores")
		...
		add("vjbase.menu.svsettings.godmode", "Modo Deus (Todos)")
		add("vjbase.menu.svsettings.bonemanip.npcs", "Manipular ossos de NPCs")
		add("vjbase.menu.svsettings.bonemanip.players", "Manipular ossos de Jogadores")
		add("vjbase.menu.svsettings.bonemanip.others", "Manipular ossos dos Outros")
		add("vjbase.menu.svsettings.timescale.general", "General TimeScale")
		add("vjbase.menu.svsettings.timescale.physics", "Physics TimeScale")
		add("vjbase.menu.svsettings.gravity", "Gravidade Geral")
		add("vjbase.menu.svsettings.maxentsprops", "Maxímo de Props/Entidades:")
		
		add("vjbase.menu.clsettings", "Opções do Cliente")
		add("vjbase.menu.clsettings.label", "Use esse menu para customizar suas opções de cliente, independente das configurações do servidor!")
		add("vjbase.menu.clsettings.labellang", "Seleção de Linguagem...")
		add("vjbase.menu.clsettings.notify.lang", "A linguagem da VJ Base é:")
		
		add("vjbase.menu.info", "Informações")
		
		add("vjbase.menu.plugins", "Plugins Instalados")
		add("vjbase.menu.plugins.label", "Lista de Plugins instalados da VJ Base.")
		add("vjbase.menu.plugins.version", "Versão:")
		add("vjbase.menu.plugins.totalplugins", "Total de Plugins:")
		add("vjbase.menu.plugins.header1", "Nome")
		add("vjbase.menu.plugins.header2", "Tipo")
		add("vjbase.menu.plugins.notfound", "Nenhum Plugin encontrado.")
		add("vjbase.menu.plugins.changelog", "Atualizações")
		add("vjbase.menu.plugins.makeaddon", "Quer fazer um Addon? Clique aqui!")
		
		-- SNPC Menus
		add("vjbase.menu.snpc.options", "Opções")
		add("vjbase.menu.snpc.options.difficulty.header", "Selecione a Dificuldade:")
		add("vjbase.menu.snpc.options.difficulty.neanderthal", "Acéfalo | -99% de Vida e Dano")
		add("vjbase.menu.snpc.options.difficulty.childs_play", "Brincadeira de Criança | -75% de Vida e Dano")
		add("vjbase.menu.snpc.options.difficulty.easy", "Fácil | -50% de Vida e Dano")
		add("vjbase.menu.snpc.options.difficulty.normal", "Normal | Vida e Dano Originais")
		add("vjbase.menu.snpc.options.difficulty.hard", "Difícil | +50% de Vida e Dano")
		add("vjbase.menu.snpc.options.difficulty.insane", "Insano | +100% de Vida e Dano")
		add("vjbase.menu.snpc.options.difficulty.impossible", "Impossível | +150% de Vida e Dano ")
		add("vjbase.menu.snpc.options.difficulty.nightmare", "Pesadelo | +250% de Vida e Dano")
		add("vjbase.menu.snpc.options.difficulty.hell_on_earth", "Inferno na Terra | +350% de Vida e Dano")
		add("vjbase.menu.snpc.options.difficulty.total_annihilation", "De cair o Cu da Bunda | +500% de Vida e Dano")
		add("vjbase.menu.snpc.options.label1", "Opções de Relação:")
		add("vjbase.menu.snpc.options.togglefriendlyantlion", "Amigável com Antlion")
		add("vjbase.menu.snpc.options.togglefriendlycombine", "Amigável com Combines")
		add("vjbase.menu.snpc.options.togglefriendlyplayer", "Amigável com Jogadores")
		add("vjbase.menu.snpc.options.togglefriendlyzombie", "Amigável com Zombies")
		add("vjbase.menu.snpc.options.togglefriendlyvj", "Amigável com SNPCs VJ")
		add("vjbase.menu.snpc.options.label2", "Todos os SNPCs VJ serão aliados!")
		add("vjbase.menu.snpc.options.label3", "Opções de Vida & Cadáveres:")
		add("vjbase.menu.snpc.options.corpselimit", "Limite de Cadáveres, Pad:32")
		add("vjbase.menu.snpc.options.label4", "Limite de Cadáveres quando 'Keep Corpses' está desligado")
		add("vjbase.menu.snpc.options.toggleundocorpses", "Cadáveres Desfaziveis (Tecla de Desfazer)")
		add("vjbase.menu.snpc.options.togglecorpsefade", "Cadáveres Desapareçem")
		add("vjbase.menu.snpc.options.corpsefadetime", "Tempo para os cadáveres desaparecerem")
		add("vjbase.menu.snpc.options.label5", "Total: 600 segundos (10 Minutos)")
		add("vjbase.menu.snpc.options.togglegibcollision", "Membros Decepados com Colisão")
		add("vjbase.menu.snpc.options.togglefadegibs", "Membros Decepados Desaparecem")
		add("vjbase.menu.snpc.options.gibfadetime", "Tempo para os Membros Decepados Desaparecerem")
		add("vjbase.menu.snpc.options.label6", "Padrão: 30 | Total: 600 segundos (10 Minutos)")
		add("vjbase.menu.snpc.options.togglesnpcgodmode", "Modo Deus (Eles não levarão nenhum dano!)")
		add("vjbase.menu.snpc.options.health", "Vida:")
		add("vjbase.menu.snpc.options.defaulthealth", "0 = Vida Padrão (Máximo de 9 dígitos!)")
		add("vjbase.menu.snpc.options.label7", "Opções de AI:")
		add("vjbase.menu.snpc.options.toggleknowenemylocation", "Sempre Sabe a Posição do Inimigo")
		add("vjbase.menu.snpc.options.sightdistance", "Distancia da Mira:")
		add("vjbase.menu.snpc.options.label8", "Cada NCP tem sua própria distancia, mas isso fara com que elas sejam iguais, use com cuidado! (0 = Original | Média: 10k)")
		add("vjbase.menu.snpc.options.processtime", "Tempo de Processo")
		add("vjbase.menu.snpc.options.whatisprocesstime", "O que é Tempo de Processo?")
		add("vjbase.menu.snpc.options.label9", "Padrão: 1 | Números mais baixos causam mais lag!")
		add("vjbase.menu.snpc.options.label10", "Opções Diversas:")
		add("vjbase.menu.snpc.options.togglegmoddecals", "Use os decalques de sangue atuais do Garry's Mod")
		add("vjbase.menu.snpc.options.label11", "Cores que não são Amarelo ou Vermelho não mudarão!")
		add("vjbase.menu.snpc.options.toggleitemdrops", "Items são largados quando morre")
		add("vjbase.menu.snpc.options.toggleshowhudonkilled", "Mostrar ícone no HUD para SNPCs mortos  (Canto superior direito)")
		add("vjbase.menu.snpc.options.toggleaddfrags", "Adicionar pontos para a scoreboard do jogador quando morto?")
		add("vjbase.menu.snpc.options.togglecreatureopendoor", "Criaturas podem abrir portas")
		add("vjbase.menu.snpc.options.togglehumansdropweapon", "Humanos largam as armas quando mortos ")
		add("vjbase.menu.snpc.options.togglehumanscanjump", "Humanos podem pular")
		add("vjbase.menu.snpc.options.toggleplydroppedweapons", "Jogadores podem pegar armas largadas")
		
		add("vjbase.menu.snpc.settings", "Opções")
		add("vjbase.menu.snpc.settings.label1", "Opções de AI:")
		add("vjbase.menu.snpc.settings.togglewandering", "Desativar patrulha quando fora de combate")
		add("vjbase.menu.snpc.settings.togglechasingenemy", "Desativar peresguição de inimigos")
		add("vjbase.menu.snpc.settings.label2", "Use essa opção com cuidado, ela pode quebrar muitas coisas!")
		add("vjbase.menu.snpc.settings.togglemedics", "Desativar SNPCs médicos")
		add("vjbase.menu.snpc.settings.togglefollowplayer", "Disativar seguir jogadores")
		add("vjbase.menu.snpc.settings.label3", "Exemplp: Quando você aperta 'E' em um SNPC ele irá te seguir")
		add("vjbase.menu.snpc.settings.toggleallies", "Desativar Allianças (Nenhum aliado!)")
		add("vjbase.menu.snpc.settings.togglebecomeenemytoply", "Desativar que aliados possam virar inimigos")
		add("vjbase.menu.snpc.settings.toggleproppush", "Desativar empurar props (Criaturas)")
		add("vjbase.menu.snpc.settings.togglepropattack", "Desativar quebrar props (Criaturas)")
		add("vjbase.menu.snpc.settings.togglescarednade", "Desativar capacidade dos humanos de correr de granadas")
		add("vjbase.menu.snpc.settings.togglereloading", "Desativar recarregamento de armas")
		add("vjbase.menu.snpc.settings.label4", "Configurações de Ataque:")
		add("vjbase.menu.snpc.settings.togglemelee", "Desativar ataques corpo a corpo")
		add("vjbase.menu.snpc.settings.togglerange", "Desativar ataques a distancia")
		add("vjbase.menu.snpc.settings.toggleleap", "Desativar ataques de pulo (Criaturas)")
		add("vjbase.menu.snpc.settings.togglethrownade", "Desativar ataques com granadas (Humanos)")
		add("vjbase.menu.snpc.settings.toggleweapons", "Disativar armas (Humanos)")
		add("vjbase.menu.snpc.settings.label5", "Humanos não serão capazes de usar armas!")
		add("vjbase.menu.snpc.settings.togglemeleedsp", "Desativar efeitos DSP em ataques corpo a corpo pesados")
		add("vjbase.menu.snpc.settings.toggleslowplayer", "Desativar jogadores ficando lentos quando atacados corpo a corpo")
		add("vjbase.menu.snpc.settings.togglebleedonmelee", "Desativar jogadores/NPCs sangrarem quando atacados corpo a corpo")
		add("vjbase.menu.snpc.settings.label6", "Opções diversas:")
		add("vjbase.menu.snpc.settings.toggleidleparticles", "Desativar particulas ociosas e efeitos")
		add("vjbase.menu.snpc.settings.label7", "Desativar isso pode ajudar com performance")
		add("vjbase.menu.snpc.settings.togglesnpcchat", "Desativar chat de SNPCs")
		add("vjbase.menu.snpc.settings.label8", "Por exemplo: 'Scientist is now following you'")
		add("vjbase.menu.snpc.settings.label9", Configurações de Dano & Cadáveres:")
		add("vjbase.menu.snpc.settings.toggleflinching", "Desativar Reação corporal a dano")
		add("vjbase.menu.snpc.settings.togglebleeding", "Desativar Sangramento")
		add("vjbase.menu.snpc.settings.label10", "Desativar particulas de sangue, decalques, poças de sangue, etc.")
		add("vjbase.menu.snpc.settings.togglebloodpool", "Desativar poças de sangue (Quando morto)")
		add("vjbase.menu.snpc.settings.togglegib", "Desativar Desmembramento")
		add("vjbase.menu.snpc.settings.label11", "Desativar isso pode ajudar na performance")
		add("vjbase.menu.snpc.settings.togglegibdecals", "Desativar decalques de Membros decepados")
		add("vjbase.menu.snpc.settings.togglegibdeathparticles", "Desativar particulas de Desmembramento/Morte e Efeitos")
		add("vjbase.menu.snpc.settings.toggledeathanim", "Desativar animações de morte")
		add("vjbase.menu.snpc.settings.togglecorpses", "Desativar Cadáveres")
		add("vjbase.menu.snpc.settings.label12", "Configurações Passivas:")
		add("vjbase.menu.snpc.settings.togglerunontouch", "Desativar correr quando tocado")
		add("vjbase.menu.snpc.settings.togglerunonhit", "Desativado correr quando ferido")
		
		add("vjbase.menu.snpc.sdsettings", "Configuração de Som")
		add("vjbase.menu.snpc.sdsettings.toggleallsounds", "Desativar todos os Sons")
		add("vjbase.menu.snpc.sdsettings.togglesoundtrack", "Desativar Trilha Sonora")
		add("vjbase.menu.snpc.sdsettings.toggleidle", "Desativar sons ociosos")
		add("vjbase.menu.snpc.sdsettings.togglebreathing", "Desativar sons de respiração")
		add("vjbase.menu.snpc.sdsettings.togglefootsteps", "Desativar sons de passos")
		add("vjbase.menu.snpc.sdsettings.toggleattacksounds", "Desativar sons de ataque corpo a corpo")
		add("vjbase.menu.snpc.sdsettings.togglemeleemiss", "Desativar sons de ataques corpo a corpo errados")
		add("vjbase.menu.snpc.sdsettings.togglerangeattack", "Desativar sons de ataque a distancia")
		add("vjbase.menu.snpc.sdsettings.togglealert", "Desativar sons de alerta")
		add("vjbase.menu.snpc.sdsettings.togglepain", "Desativar sons de dor")
		add("vjbase.menu.snpc.sdsettings.toggledeath", "Desativar sons de morte")
		add("vjbase.menu.snpc.sdsettings.togglegibbing", "Desativar sons de desmembramento")
		add("vjbase.menu.snpc.sdsettings.label1", "Tempe se aplica a o son de quando um membro decepado é colidido com algo")
		add("vjbase.menu.snpc.sdsettings.togglemedic", "Desativa sons de medico")
		add("vjbase.menu.snpc.sdsettings.togglefollowing", "Desativa sons de seguir")
		add("vjbase.menu.snpc.sdsettings.togglecallhelp", "Desativa sons de pedido por socorro")
		add("vjbase.menu.snpc.sdsettings.togglereceiveorder", "Desativa sons de recebendo ordens")
		add("vjbase.menu.snpc.sdsettings.togglebecomeenemy", "Desativa sons de virando hostil a o jogador")
		add("vjbase.menu.snpc.sdsettings.toggleplayersight", "Desativa sons de avistamento do jogador")
		add("vjbase.menu.snpc.sdsettings.label2", "Sons especiais que tocam quando um SNPC avista um jogador")
		add("vjbase.menu.snpc.sdsettings.toggledmgbyplayer", "Desativa sons de dado por jogador")
		add("vjbase.menu.snpc.sdsettings.label3", "Quando um jogador causa danos a um SNPC, usualmente um SNPC amigável")
		add("vjbase.menu.snpc.sdsettings.toggleleap", "Desativa sons de ataque de pulo")
		add("vjbase.menu.snpc.sdsettings.toggleslowedplayer", "Desativa sons de jogador atordoado")
		add("vjbase.menu.snpc.sdsettings.label4", "Sons que tocam quando o jogador é atordoado por um ataque corpo a corpo")
		add("vjbase.menu.snpc.sdsettings.togglegrenade", "Desativar sons de ataque por granada")
		add("vjbase.menu.snpc.sdsettings.togglegrenadesight", "Desativar sons de avistamento de granada")
		add("vjbase.menu.snpc.sdsettings.togglesuppressing", "Desativa sons de pedido por supressão")
		add("vjbase.menu.snpc.sdsettings.togglereload", "Desativa sons de aviso de recarregamento")	
		end
